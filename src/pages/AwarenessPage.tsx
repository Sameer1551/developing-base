  ...
  const awarenessContent: AwarenessContent[] = [
    {
      ...
      type: 'guide',
      duration: '8 min read',
      image: '/images/pexels-sagarsintan-12730345.jpg',
      difficulty: 'beginner',
      rating: 4.8,
      views: 1247,
    ...
    },
    {
      ...
      type: 'video',
      duration: '4 min',
      image: '/images/pexels-sdas-974398.jpg',
      difficulty: 'beginner',
      rating: 4.9,
      views: 2156,
    ...
    },
    {
      ...
      type: 'infographic',
      image: '/images/pexels-sratk07-10029347.jpg',
      downloadUrl: '#',
    ...
    },
    {
      ...
      type: 'video',
      duration: '15 min',
      image: '/images/bhuban-narzari-aYqR5IIrRt8-unsplash.jpg',
      difficulty: 'intermediate',
      rating: 4.9,
      views: 3421,
    ...
    },
    {
      ...
      image: '/images/evenezer-marak-_fiWkqbx_b0-unsplash.jpg',
      difficulty: 'beginner',
      rating: 4.6,
      views: 1567,
      lastUpdated: '1 week ago',
    ...
    },
    {
      ...
      category: 'Waterborne Diseases',
      type: 'infographic',
      image: '/images/evenezer-marak-_xA0u9CE3U8-unsplash.jpg',
      downloadUrl: '#',
      difficulty: 'intermediate',
      rating: 4.5,
      views: 1342,
    ...
    },
    {
      ...
      image: '/images/pexels-rihan-ishan-das-739500-13944604.jpg',
      difficulty: 'beginner',
      rating: 4.8,
      views: 987,
    ...
    },
    {
      ...
      image: '/images/pexels-hpchothe93-14138930.jpg',
      difficulty: 'intermediate',
      rating: 4.7,
      views: 2341,
      lastUpdated: '1 week ago',
    ...
    {
      id: '13',
      title: 'Water Filtration Systems: Home and Community Solutions',
      description: 'Comprehensive guide to different water filtration systems suitable for homes and communities, including cost-effective options.',
      category: 'Water Purification',
      type: 'video',
      duration: '18 min',
      image: '/images/pexels-sdas-974398.jpg',
      ...
      views: 1876,
      lastUpdated: '3 days ago',
      tags: ['filtration', 'home systems', 'community', 'cost-effective']
    },
    {
      id: '14',
      title: 'Hepatitis A Prevention Through Clean Water',
      description: 'Essential information about Hepatitis A transmission through contaminated water and effective prevention strategies for communities.',
      category: 'Waterborne Diseases',
      type: 'infographic',
      image: '/images/pexels-sratk07-10029347.jpg',
      downloadUrl: '#',
      ...
      views: 2156,
      lastUpdated: '2 days ago',
      tags: ['hepatitis A', 'water contamination', 'prevention', 'vaccination']
    },
    {
      id: '15',
      title: 'Community Water Source Protection',
      description: 'Learn how to protect community water sources from contamination through proper land use, waste management, and monitoring.',
      category: 'Water Conservation',
      type: 'article',
      ...
      views: 1345,
      lastUpdated: '1 week ago',
      tags: ['source protection', 'land use', 'waste management', 'monitoring']
    },
    {
      id: '16',
      title: 'Water Storage Safety: Preventing Contamination',
      description: 'Best practices for safe water storage in homes and communities to prevent contamination and ensure water quality.',
      ...
      views: 987,
      lastUpdated: '4 days ago',
      tags: ['storage safety', 'contamination prevention', 'best practices']
    },
    {
      id: '17',
      title: 'Mobile Health Monitoring: Community Outreach',
      description: 'How mobile health monitoring technology can improve community health outcomes and early disease detection.',
      category: 'Community Water',
      type: 'video',
      duration: '12 min',
      image: '/images/pexels-dizitalboost-11622977.jpg',
      difficulty: 'beginner',
      rating: 4.6,
      views: 1456,
      lastUpdated: '5 days ago',
      tags: ['mobile health', 'community outreach', 'early detection', 'technology']
    },
    {
      id: '18',
      title: 'Water Quality Standards: Understanding Guidelines',
      description: 'Understanding national and international water quality standards and how they apply to community water systems.',
      category: 'Water Testing',
      type: 'article',
      duration: '16 min read',
      image: '/images/pexels-devansh-bahuguna-781255210-26755241.jpg',
      difficulty: 'advanced',
      rating: 4.8,
      views: 1123,
      lastUpdated: '1 week ago',
      tags: ['quality standards', 'guidelines', 'national standards', 'international']
    }
  ];
